...
Ic1 = [0,0,0;
       0,m1*L1^2,0;
       0,0,m1*L1^2]; % Point mass at the distal end (no rotational or angular inertia)
% Angular velocity
w1_1 = R1_0 * w0_0 + qd1z;
% Angular accel
...
Ic2 = [m2*q2^2,0,0;
       0,m2*q2^2,0;
       0,0,0]; % Point mass at the distal end (no rotational or angular inertia)
% Angular velocity
w2_2 = R2_1 * w1_1;
% Angular accel
wd2_2 = R2_1 * wd1_1;
...
%%% Link 2
f2_2 = F2_2 + R2_3 * f3_3;
n2_2 = N2_2 + R2_3 * n3_3 + cross(Pc2_2, F2_2) + cross(P1_2, R2_3 * f3_3);
tau2 = transpose(f2_2) * [0;0;1]

%%% Link 1
f1_1 = F1_1 + R1_2 * f2_2;
n1_1 = N1_1 + R1_2 * n2_2 + cross(Pc1_1, F1_1) + cross(P0_1, R1_2 * f2_2);
